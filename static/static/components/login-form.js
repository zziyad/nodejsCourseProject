...
class LoginForm extends HTMLElement {
  ...
  .form__link:hover {
    ...
    createAccountForm.addEventListener("submit", async (e) => {
      ...
      if (log === "" || email === "" || pass === "")
        return setFormMessage(createAccountForm, "error", "Missing field");
      if (pass !== pass2)
        return setFormMessage(
          createAccountForm,
          "error",
      ...
      if (apiCall.status === "success") {
        setFormMessage(
          createAccountForm,
          "success",
          "Registration completed succssefully. The page will aoutomatically redirected"
        );
